...
/**
 * history_file - The function that will get file history
 * @info: parameters
...
/**
 * write_history - The function that add/create file
 * @info: parameters
...
/**
 * read_history - The function that will read history from a file
 * @info: structures
...
/**
 * list_history - The function that will add entry list
 * @info: structures
 * @buf: buffers
 * @linecount: linecount
 * Return: 0
...
/**
 * renum_history - That Will re-number
 * @info: structs
 * Return: histcnt
 */
