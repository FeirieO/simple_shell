...
/**
 * input_buffer - multiple of commands
 * @info: parameters
 * @buf: to address
...
/**
 * get_input -  that does not include a new line
 * @info: parameters
 * Return: bytes read
 */
...
/**
 * rd_buffer - Will reads the buffers
 * @info: parameters
 * @buf: buffers
 * @i: sizes
 * Return: r
...
/**
 * _getline - Will get all the following lines
 * @info: parameters
 * @ptr: pointers
 * @length: a length
 * Return: s
...
/**
 * sigintHandler - That will blocks ctrl-C
 * @sig_num: signal nums
 * Return: void
 */
